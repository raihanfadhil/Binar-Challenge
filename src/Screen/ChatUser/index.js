...
const ChatUser = props => {
  ...
  useEffect(() => {
    ...
    return () =>  firebase.app()
    .database('https://chattingapp-3b6b9-default-rtdb.asia-southeast1.firebasedatabase.app/').ref('/messages'+ receiverData.roomId).off('child_added', onChildAdd);
  }, [receiverData.roomId]);
  ...
  const sendMsg = () => { 
    ...
    const newReference = firebase.app()
    .database('https://chattingapp-3b6b9-default-rtdb.asia-southeast1.firebasedatabase.app/')
    .ref('/messages/' + receiverData.roomId)
    .push();
